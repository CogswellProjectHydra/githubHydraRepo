...
#
# Created: Thu Oct 23 11:22:39 2014
...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.projectLabel = QtGui.QLabel(self.layoutWidget1)
        self.projectLabel.setObjectName(_fromUtf8("projectLabel"))
        self.formLayout_thisNodeLabels.setWidget(4, QtGui.QFormLayout.LabelRole, self.projectLabel)
        self.projectComboBox = QtGui.QComboBox(self.layoutWidget1)
        self.projectComboBox.setObjectName(_fromUtf8("projectComboBox"))
        self.formLayout_thisNodeLabels.setWidget(4, QtGui.QFormLayout.FieldRole, self.projectComboBox)
        self.nodeVersionLabelLabel_2 = QtGui.QLabel(self.layoutWidget1)
        self.nodeVersionLabelLabel_2.setObjectName(_fromUtf8("nodeVersionLabelLabel_2"))
        self.formLayout_thisNodeLabels.setWidget(5, QtGui.QFormLayout.LabelRole, self.nodeVersionLabelLabel_2)
        ...
        self.formLayout_thisNodeLabels.setWidget(5, QtGui.QFormLayout.FieldRole, self.restrictToProjectLabel)
        ...
        self.formLayout_thisNodeLabels.setWidget(7, QtGui.QFormLayout.LabelRole, self.nodeVersionLabelLabel_3)
        ...
        self.formLayout_thisNodeLabels.setWidget(7, QtGui.QFormLayout.FieldRole, self.capabilitiesLabel)
        ...
        self.formLayout_thisNodeLabels.setWidget(6, QtGui.QFormLayout.LabelRole, self.nodeVersionLabelLabel_4)
        ...
        self.formLayout_thisNodeLabels.setWidget(6, QtGui.QFormLayout.FieldRole, self.minPriorityLabel)
        ...
        self.scrollAreaWidgetContents_recentTasks.setGeometry(QtCore.QRect(0, 0, 1234, 392))
    ...
    def retranslateUi(self, FarmView):
        ...
        self.nodeVersionLabelLabel_2.setText(_translate("FarmView", "Restrict to project:", None))
