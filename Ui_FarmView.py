...
#
# Created: Sun Feb 24 22:17:11 2013
...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.widget.setGeometry(QtCore.QRect(120, 100, 221, 24))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.formLayout_2 = QtGui.QFormLayout(self.widget)
        self.formLayout_2.setMargin(0)
        self.formLayout_2.setObjectName(_fromUtf8("formLayout_2"))
        self.projectLabel = QtGui.QLabel(self.widget)
        ...
        self.projectComboBox = QtGui.QComboBox(self.widget)
    ...
    def retranslateUi(self, FarmView):
        ...
        self.nodeNameLabel.setText(_translate("FarmView", "Press Fetch Button", None))
        self.nodeStatusLabelLabel.setText(_translate("FarmView", "Node status:", None))
        self.nodeStatusLabel.setText(_translate("FarmView", "Press Fetch Button", None))
        self.taskIDLabelLabel.setText(_translate("FarmView", "Task ID:", None))
        self.taskIDLabel.setText(_translate("FarmView", "Press Fetch Button", None))
        self.projectLabel.setText(_translate("FarmView", "Project:", None))
        self.projectComboBox.setItemText(0, _translate("FarmView", "Press Fetch Button", None))
        self.projectComboBox.setItemText(1, _translate("FarmView", "Project X", None))
        self.projectComboBox.setItemText(2, _translate("FarmView", "Ericsson", None))
